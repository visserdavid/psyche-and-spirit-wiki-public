...
- **[Near-death experiences](../concepts/near-death-experiences.md)**: Moody's original fifteen-element composite model — noise, peace, out-of-body separation, the dark tunnel, meeting other spirits, the being of light, the panoramic life review, approaching a border, and a reluctant return — is the founding vocabulary of the entire field; this ingest makes the wiki's near-death-experiences page primary-sourced for the first time.
- **The life review and judgment**: the panoramic, simultaneous re-experiencing of one's life, conducted not as external condemnation by the being of light but as self-judgment through felt knowledge of one's own acts and their effect on others — centred on two questions Moody found recurring almost verbatim: "Are you prepared to die?" and "What have you done with your life to show me?"
- **Negative and bewildered-spirit accounts**: *Reflections* documents "a realm of bewildered spirits" — confused, dulled beings apparently unable to release attachment to the physical world — and states plainly that suicide-associated NDEs are uniformly unpleasant, complicating any simple claim that all NDEs are blissful.
- **Historical and scriptural parallels**: Moody draws explicit comparisons to Paul's Damascus-road vision, Plato's *Phaedo* and the myth of Er, the *Tibetan Book of the Dead*, and Emanuel Swedenborg's accounts of the afterlife — arguing the recurring pattern long predates modern resuscitation medicine.
- **Methodological candor**: Moody is explicit throughout that the study is not a controlled scientific investigation — the sample is self-selected and non-random, corroboration is rare, and the work does not constitute proof of survival after death — while arguing the phenomenon's consistency across independent, uninfluenced accounts still merits serious study.
- **Candidate explanations and their limits**: Moody surveys and finds each incomplete — pharmacological effects (the ketamine/nitrous-oxide comparison), cerebral anoxia, temporal-lobe seizure activity, autoscopic hallucination, and isolation-research parallels — noting in particular that many NDEs occur without any drugs administered and without the physiological stress required by the anoxia hypothesis.
...
- [Elisabeth Kübler-Ross](../thinkers/elisabeth-kubler-ross.md)
