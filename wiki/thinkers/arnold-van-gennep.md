...
**Summary**: French ethnographer and folklorist (1873–1957) who coined the term "rites of passage" and identified their universal three-phase structure (separation, margin/limen, aggregation) in his 1909 work *[The Rites of Passage](../sources/the-rites-of-passage.md)* — the direct theoretical foundation for [Victor Turner](victor-turner.md)'s theory of liminality and communitas.
...
Arnold van Gennep was a French ethnographer, folklorist, and comparative religionist working in the early structural-functionalist tradition — a contemporary of Durkheim's school of sociology, though intellectually independent of it and frequently marginalized by the French academic establishment of his time (Durkheim's *The Elementary Forms of the Religious Life*, published three years after *Les rites de passage*, makes no mention of van Gennep's work). His 1909 book *[The Rites of Passage](../sources/the-rites-of-passage.md)* first identified that ceremonies marking a change of place, state, social position, or age share a common underlying structure across cultures, regardless of their specific content. He divided this structure into three phases:

1. **Separation** — rites detaching the individual from a previous fixed point in the social structure.
2. **Margin** (or **limen**, Latin for "threshold") — the intervening, ambiguous period in which the subject has none of the attributes of the past or coming state.
3. **Aggregation** (or incorporation) — rites marking the return, in a new state, with new rights and obligations.
...
- [Victor Turner](victor-turner.md)
